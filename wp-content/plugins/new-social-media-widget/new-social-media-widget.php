...
class New_Social_Media extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="row text-center">	
			...
			<?php } ?>
			<?php if($rss) { ?>
			<a href="<?php echo $rss; ?>" class="social-media-link-<?php echo $nsmw_widget_id; ?>"><div class="nsmw-div-<?php echo $nsmw_widget_id; ?> <?php echo $columns; ?>"><i class='fa fa-rss fa-<?php echo $icon_size; ?>x' aria-hidden='true'></i></div></a>
			<?php } ?>
			<?php if($whatsapp) { ?>
			<a href="<?php echo $whatsapp; ?>" class="social-media-link-<?php echo $nsmw_widget_id; ?>"><div class="nsmw-div-<?php echo $nsmw_widget_id; ?> <?php echo $columns; ?>"><i class='fa fa-whatsapp fa-<?php echo $icon_size; ?>x' aria-hidden='true'></i></div></a>
			<?php } ?>
			<?php if($email) { ?>
